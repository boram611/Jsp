...
public class oneToOneCommand implements MainCommand {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response, HttpSession session) {
		...
		lists = qnadao.selectAllQnA(currentPage, pageSize);
		request.setAttribute("list", lists);  
		//전체 글 갯수 구하기
		int totalRow = qnadao.getQnACount();
		...
		request.setAttribute("McurrentPage",currentPage); 
		request.setAttribute("MtotalRow",new Integer(totalRow));   //총 글 갯수 생략 가능성
		request.setAttribute("MtotalPage",new Integer(totalPage)); 
		request.setAttribute("MstartPage",new Integer(startPage)); 
		request.setAttribute("MendPage",new Integer(endPage)); 
	}
