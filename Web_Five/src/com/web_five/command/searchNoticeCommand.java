...
public class searchNoticeCommand implements MainCommand {
...
final int pageSize=12;
		...
		dtos = dao.noticeSearch(currentPage, pageSize, select, content);
		System.out.println(dtos.get(0));
		request.setAttribute("manageNotice", dtos);  				
