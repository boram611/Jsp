...
public class insertProductCommand implements MainCommand {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response, HttpSession session) {
		...
		PDao pdao = new PDao();
		pdao.productWrite(ctgType, prdName, prdPrice, prdStock, prdContent, prdFilename, prdDFilename, prdAFilename);
	}
