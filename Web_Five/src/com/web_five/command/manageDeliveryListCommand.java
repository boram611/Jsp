...
public class manageDeliveryListCommand implements MainCommand {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response, HttpSession session) {
		...
		dtos = dao.OrderinfoList(currentPage, pageSize);
		
		request.setAttribute("deliveryList", dtos);  				
				
		//전체 글 갯수 구하기
		int totalRow = dao.getOrderinfoCount();
