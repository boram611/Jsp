...
public class myEventListCommand implements MainCommand {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response, HttpSession session)
		...
		// TODO Auto-generated method stub
				...
				dtos = dao.myeventList(currentPage, pageSize, userId);
				
				request.setAttribute("myEventList", dtos);  				
						
				//전체 글 갯수 구하기
				int totalRow = dao.getMyEventCount(userId);
