...
{                                           
    ...
    if(newMem.address.value == "") 
    {
    	...
    	if(newMem.tel1.value == "") 
    {
		alert("전화번호 앞자리 국번을 입력해 주세요!");
		newMem.tel1.focus();
		return;
    }
	...
	if(newMem.emailid.value == "") 
    {
		alert("이메일 앞자리를 입력해 주세요!");
		newMem.emailid.focus();
		return;
    }

    if(newMem.emaildomain1.value == "") 
    {
		alert("주민등록번호 뒷자리를 입력해 주세요!");
		newMem.emaildomain1.focus();
		return;
    }
	...
	function m_nocheckValue(){
	location.href="selectAllMember.jsp";
	}


	function ma_nocheckValue(){
	location.href="member.html";
	}


	function m_checkmain(){
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//  login_agree.jsp 내에서 사용되는 자바스크립트 코드의 시작부
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

function chk(){
 var req = document.newMem_agree.req.checked;
 var num = 0;
 if(req == true){
  num = 1;
 }
 if(num==1){
  document.newMem_agree.submit();
 }else{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//  login_agree.jsp 내에서 사용되는 자바스크립트 코드의 끝
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
